...
import com.gssk.gssk.security.email.EmailSender;
...
public class ResetPasswordService {
    ...
    public String forgotPassword(RegistrationRequest request) throws AppUserNotFoundException {
        ...
        String resetPasswordLink = "http://localhost:8080/api/account/confirm?token=" + token;
        emailSender.send(email,buildEmail(email,resetPasswordLink));
        return token;
    }
